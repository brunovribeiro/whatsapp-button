...
let SnapbotButton = /** @class */ (() => {
      ...
      <div id="container-snapbot">
        ...
        <div id="content">
            <form @submit="${this.__submit}" action="post">
              ...
              <button id="action-snapbot" class="shadow">${this.button}</button>
            </form>
    ...
    `;
        ...
        async loadConfig() {
            let result = await fetch(`${config.baseUrl}/widget/load`, {
                method: 'get',
                headers: {
